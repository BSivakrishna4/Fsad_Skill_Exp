...
const App = () => {
  ...
  function forgotPassword(){
    ...
    const data = JSON.stringify({email: signinData.email});
    callApi("POST", BACKENDURL + "email/sendpassword", data, forgotPasswordResponse);
  }
    ...
    <div className='app'>
      {isSignin === true && 
        <div className='signin'>
          ...
          <label>Forgot <span onClick={()=>forgotPassword()}>Password?</span></label>
